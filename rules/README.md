...
**Testing discipline, PM2-first validation (Kotlin + Kotlin/JS/Wasm + Python), log review, docs/rules upkeep:** Read **`14-testing-validation-pm2-and-documentation.md`** — extends `11` with **always run + read logs + fix before continue**, **complete PM2 environment per feature**, **pragmatic test/code order**, and **pinning forthcoming work in `plans/`** while updating **`rules/`** / **`docs/`** when implementation changes the standard.
