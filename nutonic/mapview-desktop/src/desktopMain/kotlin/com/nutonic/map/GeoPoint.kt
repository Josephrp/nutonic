...
operator fun DisplayPoint.minus(other: DisplayPoint): DisplayPoint = DisplayPoint(this.x - other.x, this.y - other.y)
...
operator fun GeoPoint.minus(minus: GeoPoint): GeoPoint = GeoPoint(x - minus.x, y - minus.y)

operator fun GeoPoint.plus(other: GeoPoint): GeoPoint = GeoPoint(x + other.x, y + other.y)
