# Source: https://github.com/IBM/terramind/blob/main/notebooks/plotting_utils.py
...
def plot_text(data, ax=None, *args, **kwargs):
    if isinstance(data, str):
        ...
        text = coords_to_text(np.array(data))
    else:
        raise ValueError()
...
def plot_modality(modality, data, ax=None, **kwargs):
    ...
    elif 'coords' in modality.lower() or 'caption' in modality.lower() or 'coordinates' in modality.lower() or 'text' in modality.lower():
