...
abstract class Dependencies {
    ...
    /** Optional game server REST client (`IMP-070`); null when networking is disabled. */
    ...
    open val externalEvents: Flow<NutonicGalleryExternalEvent> = emptyFlow()
...
abstract class PopupNotification(
...
internal val LocalInternalEvents =
    staticCompositionLocalOf<Flow<NutonicGalleryExternalEvent>> {
        noLocalProvidedFor("LocalInternalEvents")
    }

internal val LocalSharePicture =
    staticCompositionLocalOf<SharePicture> {
