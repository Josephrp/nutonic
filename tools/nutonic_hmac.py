...
def nutonic_hmac_headers(method: str, url: str, secret: str) -> dict[str, str]:
...
def nutonic_hmac_headers_from_env(method: str, url: str) -> dict[str, str]:
    ...
    if not sec:
        return {}
    return nutonic_hmac_headers(method, url, sec)
