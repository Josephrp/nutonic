...
/** Exposed for non-`storage` packages that need the app documents root (`IMP-080`). */
fun iosDocumentsDirectory(): NSURL = NSFileManager.defaultManager.DocumentDirectory
