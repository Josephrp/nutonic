...
| 0.5 | 2026-04-18 | **§7** **`streetview_pano_service`** row: **IMP-110** normative WBS — [`plans/2026-04-18-streetview-google-perpendicular-sampling-full-scope.md`](2026-04-18-streetview-google-perpendicular-sampling-full-scope.md); gap analysis **v1.3**. |
