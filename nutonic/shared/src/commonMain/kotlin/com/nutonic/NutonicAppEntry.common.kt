...
import com.nutonic.view.*

/** Desktop / Android keyboard and platform hooks for the legacy photo gallery flow. */
enum class NutonicGalleryExternalEvent {
    Next,
    Previous,
    ReturnBack,
}
...
fun NutonicAppWithDependencies(dependencies: Dependencies) {
    CompositionLocalProvider(
        ...
        NutonicApp(
            ...
            nutonicApiClient = dependencies.nutonicApiClient,
        )
    }
}
...
@Composable
fun NutonicPhotoGalleryFlow(pictures: SnapshotStateList<PictureData>) {
    ...
    LaunchedEffect(Unit) {
        externalEvents.collect {
            if (it == NutonicGalleryExternalEvent.ReturnBack) {
