...
| [`2026-04-18-streetview-google-perpendicular-sampling-full-scope.md`](2026-04-18-streetview-google-perpendicular-sampling-full-scope.md) | **IMP-110 normative WBS:** real Google Static (`pano=` single-pano capture), **`heading_mode`** (OMNI / perpendicular-to-road / legacy radial), OSM·Mapbox·Roads·optional **Street View Tiles** road bearing, batch + HF Jobs + tests + manifest `model_pins` — supersedes ad-hoc sampling notes elsewhere until tasks close. |
